                                            ...
                                            <div class="row">
                                                <div class="col-xl-4 col-sm-4 border-right-1 prf-col">
                                                    <div class="profile-name">
                                                        @if ($dataPetugas->role == "admin")
                                                            <h4 class="text-primary"><b class="text-danger">Admin</b><b class="text-dark"> | </b>{{ $dataPetugas->nama }}</h4>
                                                        @elseif ($dataPetugas->role == "petugas")
                                                            <h4 class="text-primary"><b class="text-warning">Petugas</b><b class="text-dark"> | </b>{{ $dataPetugas->nama }}</h4>
                                                        @endif
                                                        <p>Nama</p>
                                                    </div>
                                                </div>
                                                <div class="col-xl-4 col-sm-4 border-right-1 prf-col">
                                                    <div class="profile-email">
                                                        <h4 class="text-muted">{{ $dataPetugas->email }}</h4>
                                                        <p>Email</p>
                                                    </div>
                                                </div>
                                                <div class="col-xl-4 col-sm-4 prf-col">
                                                    <div class="profile-call">
                                                        <h4 class="text-muted">{{ $dataPetugas->no_telepon }}</h4>
                                                        <p>Phone No.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div id="about-us" class="tab-pane fade active show">
                                                <div class="profile-personal-info pt-5">
                                                    ...
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-9"><span>{{ $dataPetugas->nama }}</span>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-4">
                                                        <div class="col-3">
                                                        ...
                                                        <div class="col-9"><span>{{ $dataPetugas->nik }}</span>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-4">
                                                        <div class="col-3">
                                                        ...
                                                        <div class="col-9"><span>{{ $dataPetugas->alamat }}</span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    @elseif ($dataPetugas->jenis_kelamin == "P")
                                                        <div class="row mb-4">
                                                            <div class="col-3">
                                                                <h5 class="f-w-500">Jenis Kelamin <span class="pull-right">:</span>
                                                                </h5>
                                                    ...
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-9"><span>{{ $dataPetugas->no_telepon }}</span>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-4">
                                                        <div class="col-3">
                                                        ...
                                                        <div class="col-9"><span>{{ $dataPetugas->email }}</span>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-4">
                                                        <div class="col-3">

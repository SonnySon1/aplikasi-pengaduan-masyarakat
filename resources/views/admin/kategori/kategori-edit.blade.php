            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Edit Data Kategori</a></li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                        ...
                                        <div class="w-100">
                                            <div class="form-group">
                                                <label class="col-lg-4 col-form-label" for="val_kategori">Kategori
                                                    ...
                                                    <div class="col-lg-12">
                                                    <input type="text" class="form-control" id="val_kategori" name="val_kategori" placeholder="Masukan Kategori" style="width: 100%;" value="{{ $dataKategori->kategori }}">
                                            ...
                                            <div class="form-group">
                                                <label class="col-lg-4 col-form-label" for="val_deskripsi">Deskripsi
                                                    ...
                                                    <div class="col-lg-12">
                                                        <textarea class="form-control" id="val_deskripsi" name="val_deskripsi" placeholder="Masukan deskripsi" style="width: 100%;">{{ $dataKategori->deskripsi }}</textarea>
